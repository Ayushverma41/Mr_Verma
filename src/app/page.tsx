    ...
    <div className="min-h-screen bg-black text-white selection:bg-accent selection:text-black">
      ...
      <main>
        ...
        <section id="about" className="pt-32 pb-20 px-6">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative flex justify-center fade-in-scroll [animation-delay:200ms]">
        ...
        <section id="contact" className="py-24 px-6 bg-white/[0.01]">
          <div className="max-w-4xl mx-auto text-center space-y-8 fade-in-scroll">
            <div className="space-y-4">
              <h2 className="text-4xl md:text-5xl font-headline font-bold">Let&apos;s build something <span className="text-primary italic">intelligent</span> together.</h2>
      ...
      <footer className="py-12 border-t border-white/5 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-1 text-white/30 text-xs uppercase tracking-tighter">
